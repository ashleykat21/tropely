...
const CATEGORIES: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      { label: "Estimated finish date", free: "Included", premium: "Included" },
      { label: "Reading calendar & heat map", free: "Included", premium: "Included" },
      { label: "Reading challenges", free: "Included", premium: "Included" },
      { label: "Reading speed calculator", free: "Included", premium: "Included" },
      { label: "Best reading time insight", free: "View only", premium: "With smart reminder" },
      { label: "Tropely Wrap", free: "Highlights teaser", premium: "Full year-in-review + sharing" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Bookshelf themes", free: "1 free theme (linen)", premium: "All textures + accent colors" },
