...
type PRetryWithAbort = typeof pRetry & { AbortError: new (e: Error) => Error };
const pRetryAbortError = (e: Error) =>
  new (pRetry as unknown as PRetryWithAbort).AbortError(e);
      ...
      pRetry(
        async () => {
          try {
            ...
            throw pRetryAbortError(error instanceof Error ? error : new Error(String(error)));
          }
        },
