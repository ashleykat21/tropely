...
import { Flame, Target, Calendar, Snowflake } from "lucide-react";
...
export function StreakStrip() {
  ...
  // Accrue weekly freeze + auto-cover missed yesterdays once per mount/day.
  useEffect(() => {
    reconcileFreeze();
  }, [reconcileFreeze]);
  ...
  return (
    <section className="rounded-2xl border border-border/50 bg-card/80 backdrop-blur p-5 shadow-soft grid gap-5 sm:grid-cols-3 sm:items-center">
      {/* Streak */}
