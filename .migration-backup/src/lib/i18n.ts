...
const DICTS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.language_help": "Choose the language used across Feltly.",
  },
  es: {
    "nav.home": "Inicio",
  ...
  de: {
    ...
    "settings.language": "Sprache", "settings.language_help": "Wähle die Sprache für Feltly.",
  },
  pt: {
    "nav.home": "Início", "nav.discover": "Descobrir", "nav.journal": "Diário",
    "nav.ai": "Companheiro", "nav.social": "Social", "nav.twins": "Gémeos",
    "nav.insights": "Análises", "nav.you": "Você",
    ...
    "settings.language": "Idioma", "settings.language_help": "Escolha o idioma da Feltly.",
  },
  it: {
    "nav.home": "Home", "nav.discover": "Scopri", "nav.journal": "Diario",
    "nav.ai": "Compagno", "nav.social": "Social", "nav.twins": "Gemelli",
    "nav.insights": "Analisi", "nav.you": "Tu",
    ...
    "settings.language": "Lingua", "settings.language_help": "Scegli la lingua di Feltly.",
  },
  ja: {
    "nav.home": "ホーム", "nav.discover": "発見", "nav.journal": "ジャーナル",
    "nav.ai": "コンパニオン", "nav.social": "ソーシャル", "nav.twins": "ツインズ",
    "nav.insights": "分析", "nav.you": "あなた",
    ...
    "settings.language": "言語", "settings.language_help": "Feltlyの言語を選択。",
  },
  zh: {
    "nav.home": "首页", "nav.discover": "发现", "nav.journal": "日志",
    "nav.ai": "伙伴", "nav.social": "社交", "nav.twins": "书友",
    "nav.insights": "洞察", "nav.you": "我",
  ...
  sv: {
    ...
    "settings.language": "Språk", "settings.language_help": "Välj språk för Feltly.",
  },
};
